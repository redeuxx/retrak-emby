...
namespace ReTrak
{
    ...
    public static class Extensions
    {
        ...
        public static string GetCodecRepresetation(this MediaStream audioStream)
        {
            ...
            {
                case "truehd":
                    return ReTrakAudio.dolby_truehd.ToString();
                case "dts":
                case "dca":
                    return ReTrakAudio.dts.ToString();
                case "dtshd":
                    return ReTrakAudio.dts_ma.ToString();
                case "ac3":
                    return ReTrakAudio.dolby_digital.ToString();
                case "aac":
                    return ReTrakAudio.aac.ToString();
                case "mp2":
                    return ReTrakAudio.mp3.ToString();
                case "pcm":
                    return ReTrakAudio.lpcm.ToString();
                case "ogg":
                    return ReTrakAudio.ogg.ToString();
                case "wma":
                    return ReTrakAudio.wma.ToString();
                case "flac":
                    return ReTrakAudio.flac.ToString();
                default:
                    return null;
            }
        }
